...
Apply + verify via /api/v2:
    python scripts/seed_v2_creator_club_venmo.py --apply
"""
...
ACCUMULATED_AMOUNT = Decimal("65226.00")
...
EXPECTED_VARIANTS: dict[str, tuple[int, int, str]] = {
    VARIANT_ACCOUNT_1_LABEL: (35, 0, "https://venmo.com/u/club-round"),
    VARIANT_ACCOUNT_2_LABEL: (35, 1, "https://venmo.com/u/godfather4444"),
    VARIANT_VENMO_3_LABEL: (15, 2, "https://venmo.com/u/jagger4444"),
    VARIANT_VENMO_4_LABEL: (15, 3, "https://venmo.com/u/michaelc4444"),
}
...
def verify_via_api(club_id: int) -> None:
    ...
    if method.get("sort_order") != 6:
        raise SystemExit(f"Expected sort_order 6, got {method.get('sort_order')!r}")
    ...
    try:
        ...
        if args.apply:
            ...
            print(
                ...
                f"accumulated=${ACCUMULATED_AMOUNT:,.2f}, sort_order=6)"
            )
