...
echo "  pre-push     — python imports + tests + dashboard build, then graphify sync, before git push / gp"
echo ""
echo "Skip once:"
echo "  BUILD_SKIP_HOOK=1 git push      — skip python imports, tests, and dashboard build"
