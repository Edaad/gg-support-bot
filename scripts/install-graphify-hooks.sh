...
echo "  pre-push     — ruff + python imports + tests + migration check + dashboard build, then graphify sync, before git push / gp"
echo ""
echo "Skip once:"
echo "  BUILD_SKIP_HOOK=1 git push      — skip ruff, python imports, tests, migration check, and dashboard build"
