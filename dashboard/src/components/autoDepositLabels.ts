export const AUTO_DEPOSIT_SKIP_REASON_LABELS: Record<string, string> = {
  ...
  no_player_id_in_title: 'No player ID in group title',
  not_creator_club: 'Club not eligible (Creator Club only today)',
  missing_club_or_chat: 'Missing club or chat',
  chip_add_failed: 'ClubGG chip-add failed',
}
