...
class VenmoGoodsServicesIssueReportTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_creates_deposit_report_for_goods_or_services(self):
        ...
        self.assertIn("*Goods & Services*", kwargs["description"])
        self.assertIn("*Venmo:* `@godfather4444`", kwargs["description"])
        self.assertNotIn("DO NOT ADD", kwargs["description"])
        self.assertNotIn("Payment ID:", kwargs["description"])
        self.assertNotIn("Staff notification:", kwargs["description"])
        self.assertNotIn("Payer:", kwargs["description"])
        self.assertNotIn("Group:", kwargs["description"])
