...
PAYMENT_NOTIFICATION_CHAT_ID_GTO_ENV = "PAYMENT_NOTIFICATION_CHAT_ID_GTO"
PAYMENT_NOTIFICATION_CHAT_ID_RT_AT_ENV = "PAYMENT_NOTIFICATION_CHAT_ID_RT_AT"
# Deprecated alias — read as fallback in rt_at_notification_chat_id().
PAYMENT_NOTIFICATION_CHAT_ID_RT_AT_CC_ENV = "PAYMENT_NOTIFICATION_CHAT_ID_RT_AT_CC"
PAYMENT_NOTIFICATION_CHAT_ID_CREATOR_CLUB_ENV = (
    "PAYMENT_NOTIFICATION_CHAT_ID_CREATOR_CLUB"
)
