...
def _method_dict(m: ClubPaymentMethod) -> dict:
    return {
        ...
        "union_type": getattr(m, "union_type", None),
        "deposit_union": getattr(m, "deposit_union", None),
        "method_tag": getattr(m, "method_tag", None),
        "payment_account_name": getattr(m, "payment_account_name", None),
